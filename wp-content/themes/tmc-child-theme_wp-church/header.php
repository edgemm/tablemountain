...
<link rel="stylesheet" class="schanger changer" href="/wp-content/themes/tmc-child-theme_wp-church/styles/gold.css" type="text/css" />
...
h6.day {
	font-family: '<?php echo $familycode; ?>', Arial, sans-serif;
	font-size: 50px;
	line-height: 40px;
...
.daydisplayw h1, h6.month, h3#reply-title, h3#comments-title {
	font-family: '<?php echo $familycode; ?>', Arial, sans-serif;
	font-size: 22px;
	line-height: 20px;
